    ...
    <main className="container mx-auto px-4 py-20">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-12">
          My <span className="text-[#00ffdd]">Education</span>
        </h1>
        ...
        <div className="grid gap-6">
          <Card className="bg-zinc-900 border-zinc-800">
            ...
            <CardContent>
              ...
              <p className="mt-2">Specialized in Human-Computer Interaction and User Interface Design</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-zinc-900 border-zinc-800">
            ...
            <CardContent>
              ...
              <p className="mt-2">Focus on Digital Design and Interactive Media</p>
            </CardContent>
          </Card>
